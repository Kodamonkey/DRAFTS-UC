...
class Colors:
    ...
    # Colores específicos para DRAFTS
    PIPELINE = '\033[38;5;39m'  # Azul claro
    DETECTION = '\033[38;5;82m'  # Verde claro
    PROCESSING = '\033[38;5;220m'  # Amarillo claro
    GPU = '\033[38;5;213m'  # Magenta claro
    FILE = '\033[38;5;87m'  # Cian claro
...
class DRAFTSLogger:
    ...
    def pipeline_start(self, config: Dict[str, Any]):
        ...
        # Leyenda de colores para mejor entendimiento
        ...
        self.logger.info("") # Línea en blanco para separación
